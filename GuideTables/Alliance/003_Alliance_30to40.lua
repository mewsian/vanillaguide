...
-----------37-38 Arathi Highlands
	...
	[3738] = {
	    ...
	    items = {
			...
			[6] = { str = "Go to the circle of east binding, just west of Hammerfall at 66,29 and grab the cresting key from the rock.", x = 66, y = 29, zone = "Arathi Highlands" },
			[7] = { str = "Stop at 60,53 and hand in  Hints of a New Plague? Pt.1  accept  Hints of a New Plague? Pt.2  If you see the courier kill them. Use cooldowns to deal with bodyguards. The courier walks between refuge and tarren mill, but on certain private servers (Nos) will stand in front of Go'Shek Farm around 61,61.", x = 61, y = 61, zone = "Arathi Highlands" },
...
-----------38-38 Dustwallow Marsh
	...
	[3838] = {
		...
		items = {
			...
			[6] = { str = "Just as you exit Theramore, go right and kill Mudrock turtles along the shore for “Mudrock Soup and Bugs”. The drop rate is really bad (25%) so if you don't need the XP then skip it." },
